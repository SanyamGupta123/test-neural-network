...
public class CommandFactory {
    ...
    public static CommandFactory init(ParkingLotCommandHandler parkingLotCommandHandler) {
        ...
        cf.addCommand("registration_numbers_for_cars_with_colour", new FindCarsByColourCommand(parkingLotCommandHandler));
        cf.addCommand("slot_numbers_for_cars_with_colour", new FindSlotsByColourCommand(parkingLotCommandHandler));
        cf.addCommand("slot_number_for_registration_number", new FindSlotByRegistrationNumberCommand(parkingLotCommandHandler));
